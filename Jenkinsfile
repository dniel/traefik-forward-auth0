        ...
        stage('Scan') {
            steps {
                container('sonar-scanner') {
                    ...
                    sh "sonar-scanner -X -Dsonar.login=\$SONAR_TOKEN -Dsonar.projectKey=dniel_traefik-forward-auth0 -Dsonar.organization=dniel-github -Dsonar.host.url=\"https://sonarcloud.io\" -Dsonar.projectVersion=${appVersion}"
                }
            }
        }
