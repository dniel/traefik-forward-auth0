...
internal class EventController(val properties: ForwardAuthSettings, val repo: EventRepository) {
    ...
    private fun createEmbeddedRepresentationEvent(event: Event): EmbeddedRepresentation {
        return EmbeddedRepresentation.newBuilder("http://x.io/rels/event")
                .clazz(event.type)
