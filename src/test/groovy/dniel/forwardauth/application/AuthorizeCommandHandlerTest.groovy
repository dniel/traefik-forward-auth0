...
class AuthorizeCommandHandlerTest extends Specification {
    ...
    def "should verify access to #host#uri based on input parameters"() {
        ...
        ObjectMother.validJwtTokenString | "HTTPS"  | "www.example.test" | "/test"          | "GET"  || true          | true
        ObjectMother.validJwtTokenString | "HTTPS"  | "www.example.test" | "/oauth2/signin" | "GET"  || true          | false
        ObjectMother.validJwtTokenString | "HTTPS"  | "www.example.test" | "/OaUth2/SiGNIn" | "GET"  || true          | false
        ObjectMother.validJwtTokenString | "HTTPS"  | "opaque.com"       | "/test"          | "GET"  || true          | true
        ObjectMother.validJwtTokenString | "HTTPS"  | "restricted.com"   | "/test"          | "GET"  || true          | false
        ObjectMother.validJwtTokenString | "HTTPS"  | "restricted.com"   | "/test"          | "POST" || true          | true
